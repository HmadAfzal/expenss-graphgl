...
const TransactionForm = () => {
	const [AddTransaction, { data, loading }] = useMutation(ADD_TRANSACTION,{refetchQueries:[GET_TRANSACTIONS,GET_TRANSACTION_STATISTICS]});
	...
	const handleSubmit = async (e) => {
		...
		try {
			await AddTransaction({ variables: { input: transactionData } });
	...
	return (
		<form className='w-full max-w-lg flex flex-col gap-5 px-3' onSubmit={handleSubmit}>
          ...
          from-pink-500 to-pink-500 hover:from-pink-600 hover:to-pink-600
				...
				disabled={loading}
			>
				{loading?'aading...':'Add Transaction' }
			</button>
		</form>
	);
};
